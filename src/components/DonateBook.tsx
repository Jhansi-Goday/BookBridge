      ...
      <header className="bg-primary text-primary-foreground py-8">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl opacity-90">Share Knowledge, Spread Joy</p>
            <p className="mt-2 opacity-75">Help build our community library by donating books you no longer need</p>
          </div>
        </div>
      </header>
